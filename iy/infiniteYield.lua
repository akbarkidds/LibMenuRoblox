        ...
        do -- no delete
            ...
            -- ==================================== Start Function Group ============================
                                    ...
                                    if q and q:IsA("Folder") then
                                        if q:FindFirstChild("Progress") then
                                            ...
                                            if quest.Name == "Normal" then
                                                ...
                                                local xx = string.find(q.Name, "Title") or 0
                                                local zz = string.find(q.Name, "Sub") or 0
                ...
                -- ======== Auto Farm =======
                    ...
                    local Toggle_AutoFarm = Tabs.Auto:AddToggle("Toggle_AutoFarm", { Title = "Auto Farm", Default = false })
                    ...
                    local autohit = Tabs.Auto:AddToggle("autohit", {Title = "Auto Attack", Default = false})
                    ...
                    local ToggleTweenToMonster = Tabs.Auto:AddToggle("ToggleTweenToMonster", { Title = "Tween Monster", Default = false })
                ...
                -- ======== Teleport =======
                    ...
                    local toggleAutoJoinDungeon = Tabs.Dungeon:AddToggle("AutoJoinDungeon", { Title = "Auto Join Dungeon", Default = false })
                            ...
                            while VariableIndex.AutoJoinDungeon and task.wait() do
                                if #DungeonSelect > 0 then
                                    ...
                                    if defaultDungeon:FindFirstChild("Dungeon") then
                                        ...
                                        if table.find(DungeonSelect, defaultDungeon:FindFirstChild("Dungeon"):GetAttribute("DungeonRank")) > 0 then
                                            local args = {
                                                {
                                                    {
                                                        Event = "DungeonAction",
